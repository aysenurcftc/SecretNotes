...
image_label = tk.Label(window, image=photo, bg="gray10")
image_label.pack()

title_label = tk.Label(text="Enter Your Title", bg="gray10", foreground="white")
title_label.pack(pady=5)

title_label_input = tk.Entry(width=50)
title_label_input.pack()

text_label = tk.Label(text="Enter Your Secret", bg="gray10", foreground="white")
text_label.pack(pady=5)

text_widget = tk.Text(window, height=15)
text_widget.pack(pady=5)

key_label = tk.Label(text="Enter Master Key", bg="gray10", foreground="white")
key_label.pack()

key_label_input = tk.Entry(width=50)
key_label_input.pack(pady=5)

save_enc_button = tk.Button(text="Save & Encrypt", command=save_title_and_secret)
